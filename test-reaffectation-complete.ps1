...
# Ce script teste que:
# 1. Le technicien A décline une demande
# 2. Le responsable réaffecte au technicien B
# 3. Le technicien A voit toujours sa demande déclinée
# 4. Le technicien B voit la demande comme EN_COURS sans infos de déclin
...
Write-Host ""
Write-Host "2. Création d'une demande de test..." -ForegroundColor Yellow
$demande = @{
...
# Étape 3: Affecter au Technicien A (ID 3)
Write-Host ""
