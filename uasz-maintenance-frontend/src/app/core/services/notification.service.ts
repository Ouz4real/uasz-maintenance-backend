...
export class NotificationService {
  ...
  constructor(private http: HttpClient) {
    // 🔔 Polling automatique toutes les 10 secondes pour TOUS les utilisateurs
    // Cela permet de recevoir les notifications en temps réel sans rafraîchir la page
    this.startPolling();
  }
  
  private startPolling(): void {
    interval(10000) // 10 secondes - polling automatique pour toutes les notifications
      .pipe(
        startWith(0),
