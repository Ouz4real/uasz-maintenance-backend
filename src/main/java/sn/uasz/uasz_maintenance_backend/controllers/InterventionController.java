...
public class InterventionController {
    ...
    /**
     * Refuser une intervention (technicien).
     * POST /api/interventions/{id}/refuser
     * Body: { "raisonRefus": "..." }
     */
    @PostMapping("/{id}/refuser")
    @PreAuthorize("hasRole('TECHNICIEN')")
    public ResponseEntity<Intervention> refuserIntervention(
            @PathVariable Long id,
        ...
        Intervention intervention = interventionService.refuserIntervention(
            id, 
            technicien.getId(), 
            raisonRefus
        );
