...
public class SuperviseurDashboardDto {
    ...
    private Double tempsMoyenResolutionMinutes;   // MTTR global (en minutes)
    ...
    private Double tempsMoyenRealisationMinutes;  // durée moyenne d'une intervention (en minutes)
}
