...
public class MaintenancePreventive {
    ...
    // Champs pour la réalisation
    private LocalDate dateRealisee; // Date effective de réalisation
    
    @Column(length = 3000)
    private String rapport; // Notes du technicien après réalisation
    
    @Column(length = 2000)
    private String piecesUtilisees; // JSON des pièces utilisées
    
    @Column(length = 500)
    private String photoUrl; // URL de la photo après maintenance
    
    private String typeEquipement; // Type d'équipement pour affichage
}
